(setq custom-file (concat default-directory "etc/emacs-custom.el"))
(load custom-file)

(add-to-list 'load-path "org-mode/lisp/")
(add-to-list 'load-path "org-mode/contrib/lisp/")
(add-to-list 'load-path "etc/vendor/emacs-htmlize")
...
(setq worg-base "./")
(setq worg-htmlroot (concat (getenv "BUILD_DIR") "orgmode.org/worg/"))
...
(setq orgweb-publish-directory (concat (getenv "BUILD_DIR") "orgmode.org/"))
(setq worg-preamble (with-temp-buffer (insert-file-contents (concat worg-base "preamble.html")) (buffer-string)))
...
;;    `(("worg" :components ("worg-org-faq" "worg-pages" "worg-code" "worg-color-themes" "worg-images" "worg-sources" "worg-extra" "worg-bibtex"))
    `(("worg" :components ("worg-org-faq" "worg-pages" "worg-code" "worg-images" "worg-sources" "worg-extra" "worg-bibtex"))
...
<link rel=\"icon\" href=\"/org-mode-unicorn.ico\" type=\"image/ico\" />"
      ...
      ("worg-code"
       ...
       :html-extension "html"
       :publishing-directory ,(concat worg-publish-directory "code/")
       :recursive t
       :publishing-function org-publish-attachment)
      ("worg-sources"
       :base-directory ,worg-base-directory
       :base-extension "org"
       :publishing-directory ,(concat worg-publish-directory "sources/")
       :recursive t
       :publishing-function org-publish-attachment)
      ("worg-images"
       :base-directory ,worg-base-directory
      ...
      ("worg-extra"
       ...
       :publishing-function org-publish-attachment)
      ("worg-bibtex"
       :base-directory "./org-contrib/bibtex/"
       :base-extension "bib"
       :publishing-directory ,(concat worg-publish-directory "org-contrib/bibtex/")
       :recursive nil
       :publishing-function org-publish-attachment)
      ("orgwebpages"
       :base-directory "./orgweb/"
       :base-extension "org"
       :html-extension "html"
       :publishing-directory ,orgweb-publish-directory
       :publishing-function (org-html-publish-to-html)
       :auto-sitemap nil
       :section-numbers nil
       :table-of-contents t
